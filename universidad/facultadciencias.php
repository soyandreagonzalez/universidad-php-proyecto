...
<head>
    ...
    <link rel="stylesheet" href="stylefacultadciencias.css">
</head>
<body>
<div class="container-top-bar">
    ...
    <div class="container">
        <picture class="container-picture">
           <a href="index.php"> <img src="./assets/registroprofelogo.png" alt=""> </a>        
        </picture>
    </div>
    <div class="container-title-facultad">
        <p>FACULTAD DE CIENCIAS</p>
    </div>
    <header class="header">
        <picture class="header-picture">
            <img src="./assets/ciencias.png" alt="">
        </picture>
    </header>

    <section class="container-programas">
        <div class="container-programas1">
            <a class="programa-sistemas a-hover" href="">
               
                    <p class="p-title">ANALISIS DE MUESTRAS</p>
                    <picture class="programa-sistemas-picture">
                        <img src="./assets/analisis.png" alt="">
                    </picture>
                
            </a>
            <a class="programa-quimica a-hover" href="">
                
                    <p class="p-title">QUÍMICA A LA INDUSTRIA</p>
                    <picture class="programa-quimica-picture">
                        <img src="./assets/medio ambiente.png" alt="">
                    </picture>
              
            </a>
        </div>
        <div class="container-programas2">
        <a class="programa-ambiental a-hover" href="">
                
                    <p class="p-title">MEDIO AMBIENTE</p>
                    <picture class="programa-ambiental-picture">
                        <img src="./assets/quimica.png" alt="">
                    </picture>
