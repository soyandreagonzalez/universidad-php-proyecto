...
<head>
    ...
    <link rel="stylesheet" href="styleingenieria.css">
...
<div class="container-top-bar">
    ...
    <div class="container">
        <picture class="container-picture">
           <a href="index.php"> <img src="./assets/iniciosesionlogo.png" alt=""> </a>        
        </picture>
    </div>
    ...
    <header class="header">
        <picture class="header-picture">
            <img src="./assets/bannerSist.jpeg" alt="">
        </picture>
    </header>
    ...
    <section class="container-programas">
        <div class="container-programas1">
            <a class="programa-sistemas a-hover" href="">
                    ...
                    <p class="p-title">SEMESTRE 1</p>
                    <picture class="programa-sistemas-picture">
                        <img src="./assets/semestre1.jpeg" alt="">
                    </picture>
                
            </a>
            <a class="programa-quimica a-hover" href="">
                
                    <p class="p-title">SEMESTRE 2</p>
                    <picture class="programa-quimica-picture">
                        <img src="./assets/semestre2.jpeg" alt="">
                    </picture>

                    <a class="programa-quimica a-hover" href="">
                
                    <p class="p-title">SEMESTRE 3</p>
                    <picture class="programa-quimica-picture">
                        <img src="./assets/semestre3 (2).jpeg" alt="">
                    </picture>
