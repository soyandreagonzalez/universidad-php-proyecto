...
<head>
    ...
    <link rel="stylesheet" href="stylefacultaddiseño.css">
</head>
<body>
<div class="container-top-bar">
    ...
    <div class="container">
        <picture class="container-picture">
           <a href="index.php"> <img src="./assets/logodiseño.png" alt=""> </a>        
        </picture>
    </div>
    ...
    <section class="container-programas">
        <div class="container-programas1">
            <a class="programa-sistemas a-hover" href="">
                    ...
                    <p class="p-title">DISEÑO GRÁFICO</p>
                    <picture class="programa-sistemas-picture">
                        <img src="./assets/diseño1.png" alt="">
                    </picture>
                
            </a>
            <a class="programa-quimica a-hover" href="">
                
                    <p class="p-title">DISEÑO DE VESTUARIO</p>
                    <picture class="programa-quimica-picture">
                        <img src="./assets/diseño2.png" alt="">
                    </picture>
        ...
        <a class="programa-ambiental a-hover" href="">
                    ...
                    <p class="p-title">DISEÑO INDUSTRIAL</p>
                    <picture class="programa-ambiental-picture">
                        <img src="./assets/diseño3.png" alt="">
                    </picture>
